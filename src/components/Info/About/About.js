      ...
      <div className='about__container section__container'>
        ...
        <div className='about__text-container'>
          ...
          <p className='about__text section__text'>
            ...
            часто получаем признание не только клиентов, но и отделочников или
            сантехников.
          </p>
          <p className='about__text section__text'>
            Мы любим то, чем занимаемся, а занимаемся только электрикой. В
            вопросах сантехники или отделки помочь не сможем. Но поделимся
            номерами телефонов подходящих мастеров.
          </p>
          <p className='about__text section__text'>
            Если работы нужно выполнить “вчера”, то, к сожалению, не возьмём
            такой объект, потому что всегда есть график работ, которому следуем.
            За скоростью выполнения не гонимся - качество монтажа на первом
            месте. Выполненная нами электропроводка не только эргономична, но и
            надёжна.
          </p>
          <p className='about__text section__text'>
